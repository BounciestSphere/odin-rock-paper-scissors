...
function playGame(){
    ...
    if (humanScore > computerScore){
        console.log(`You win! Awesome ${humanScore} to ${computerScore} victory!`);
        return;
    }
        ...
        console.log(`The most boring result of them all: an overall tie, ${humanScore} to ${computerScore}`);
        return;
    }
}
